...
let respuesta = fEjecutar(fAfirmativo, fError) 
console.warn(
    (respuesta[1])
        ?(console.log(respuesta [0]), `se ejecuta el callbackE fAfirmativo`)  
        :(console.error(respuesta[0]),`se ejecuto el caballbacke fError`)
    );
